...
# process.
rst_epilog = """
.. |service| replace:: Customer Management Service
.. |api-service| replace:: Customer Management Service
.. |contract version| replace:: 4.24.0
.. |product name| replace:: Customer Management Service
"""
...
# html_title = "Rackspace Customer Management Service API 4.24.0"

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = None
html_short_title = "Rackspace Customer Management Service API 4.24.0"
